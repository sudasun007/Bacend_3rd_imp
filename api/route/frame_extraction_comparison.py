...
try:
    ...
    logging.info("Frame extraction and comparrison Model loaded successfully.")
...
def send_frames_to_preprocessing(frames_data,email,video_name):
    ...
    preprocessing_url = f'http://{ipv4_address}:5000/api/preprocessing_api/preprocessing'
...
def process_local_video():
    ...
    logging.info(email)
    video_path = f"C:/Users/USER/Desktop/New_Flask_Backend/uploads/{_title}"
